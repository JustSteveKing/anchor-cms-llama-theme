...
<html lang="en">
  <head>
	...
	<meta name="twitter:title" content="<?php echo site_name();?> | <?php echo article_title(); ?>">
	<meta name="twitter:description" content="<?php echo article_description(); ?>">
	<meta name="twitter:creator" content="@JustSteveKing">
	<meta name="twitter:image:src" content="http://thedevshed.co.uk<?php echo article_custom_field('image');?>">
	<meta name="twitter:domain" content="<?php echo full_url(); ?>">

	<meta property="og:title" content="<?php echo site_name(); ?>">
	<meta property="og:type" content="website">
	<meta property="og:url" content="<?php echo full_url(); ?><?php echo current_url(); ?>">
	<meta property="og:image" content="http://thedevshed.co.uk<?php echo article_custom_field('image');?>">
